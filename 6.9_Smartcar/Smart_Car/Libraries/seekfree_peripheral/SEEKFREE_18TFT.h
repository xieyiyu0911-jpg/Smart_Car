...
#define	TFT_SCL_SIMSPI_PIN 		P25				//定义SPI_SCK引脚P26
#define	TFT_SDA_SIMSPI_PIN		P23   			//定义SPI_MOSI引脚P27
#define TFT_REST_SIMSPI_PIN  	P20				//定义复位引脚P45
#define TFT_DC_SIMSPI_PIN	  	P21				//液晶命令位引脚定义P46
#define TFT_CS_SIMSPI_PIN	  	P22				//定义SPI_CS引脚P00
#define TFT_BL_SIMSPI_PIN	  	P27				//液晶背光引脚定义P01  
...
#define TFT_SPIN 		SPI_CH2			//定义使用的SPI号SPI_CH1
#define	TFT_SCL_PIN 	SPI_CH2_SCLK_P25	//定义SPI_SCK引脚SPI_CH1_SCLK_P15
#define	TFT_SDA_PIN		SPI_CH2_MOSI_P23   //定义SPI_MOSI引脚SPI_CH1_MOSI_P13
#define	TFT_SDA_IN_PIN	SPI_CH1_MISO_P14   //定义SPI_MISO引脚  TFT屏幕没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用SPI_NULL_PIN
#define TFT_REST_PIN  	P20				//P47
#define TFT_DC_PIN	  	P21				//液晶命令位引脚定义P11
#define TFT_CS_PIN	  	P22				//定义SPI_CS引脚P10
#define TFT_BL_PIN	  	P27				//液晶背光引脚定义P22
