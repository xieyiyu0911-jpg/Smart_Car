...
#define OLED_SCL_PIN  P15		//P15 原来是P25
#define OLED_SDA_PIN  P14   //P14 原来是P23
#define OLED_REST_PIN P47		//液晶复位引脚定义
#define OLED_DC_PIN   P11   	//液晶命令位引脚定义
#define OLED_CS_PIN   P10   	//定义SPI_CS引脚
...
#define OLED_SPI_SCLK_PIN   SPI_CH1_SCLK_P15
#define OLED_SPI_MOSI_PIN   SPI_CH1_MISO_P14
#define OLED_SPI_MISO_PIN   SPI_NULL_PIN	//SPI_NULL_PIN 定义SPI_MISO引脚  OLED屏幕没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define OLED_SPI_REST_PIN 	P47				//液晶复位引脚定义
#define OLED_SPI_DC_PIN   	P11   			//液晶命令位引脚定义
#define OLED_SPI_CS_PIN     P10				//定义硬件SPI_CS引脚
