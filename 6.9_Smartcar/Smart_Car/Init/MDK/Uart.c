...
#pragma float64
 ...
 extern uint16 Result_L, Result_Middle_M_L,Result_Middle_M_R,Result_R;// ���ֵ
 ...
 extern float xdata Angle_Speed_error1;
...
void SCI_Send_Datas(UARTN_enum uart_num)// ��λ���鿴���κͱ����ĺ���
{
	  int i, j;
