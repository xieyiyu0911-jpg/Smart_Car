...
#define FAN_DUTY_CRUISE_BASE      (780.0f)  //��׼ռ�ձ�
#define FAN_DUTY_CRUISE_MIN       (650.0f)  //��Сռ�ձ�
#define FAN_DUTY_CRUISE_MAX       (950.0f)  //���ռ�ձ�
#define FAN_DUTY_UPHILL_ADD       (80.0f)  //���¼�
#define FAN_DUTY_DOWNHILL_SUB     (40.0f)  //���¼�
#define FAN_PITCH_UPHILL_TH       (10.0f)  //������>10����
#define FAN_PITCH_DOWNHILL_TH     (-10.0f)  //������<-10����
