...
//#define FOSC					0			// FOSC的值设置为0，则内核频率通过寄存器强制设置为33.1776Mhz，
//											// 不管STC-ISP软件下载时候选择多少，他都是33.1776Mhz。
											
#define FOSC          		22118400	// FOSC的值设置为33.1776Mhz,
											// 使用STC-ISP软件下载的时候，
...
#define DEBUG_UART_RX_PIN  		UART4_RX_P02
#define DEBUG_UART_TX_PIN  		UART4_TX_P03
